...
needed to preserve relations including the fields already selected. Together, they make replay
semantically sufficient and let us obtain an exact projection of the relational producer state.
...
For every replay set \(A\) satisfying Replay Closure,
\[
...
\(\filter^\sharp(A,I^\sharp)\) must represent \(\ProjClose_A(\gamma(I^\sharp))\) exactly,
